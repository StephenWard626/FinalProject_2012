...
namespace FinalProject_0512.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GroupID,GroupName,GroupGenre,GroupSeries,MemberCount")] Groups groups)
        {
